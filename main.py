...
from handlers.user import (
    start, back_to_start,
    show_catalog, show_product, initiate_buy,
    my_orders, help_menu,
    wallet_menu, topup_menu, topup_custom, topup_receive_custom, topup_fixed,
    my_profile, ranking,
)
from handlers.admin import (
    admin_panel, adm_panel_callback, adm_stock, adm_balances,
    add_codes_conv, refund_conv,
)
...
def build_telegram_app() -> Application:
    ...
    # ── ConversationHandlers (prioridade máxima) ──────────────
    ...
    # ── Texto livre no DM (valor personalizado de recarga) ────
    ...
    app.add_handler(CallbackQueryHandler(initiate_buy,  pattern="^no_balance$"))
